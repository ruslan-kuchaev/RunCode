...
export default function TasksPage() {
    ...
    useGSAP(() => {
        if (menuSelectedLayout === "grid" && tasksGridRef.current) {
        ...
        if (menuSelectedLayout === "list" && tasksListRef.current) {
    ...
    }, { dependencies: [filteredTasks, menuSelectedLayout] });
                    ...
                    <div ref={filtersRef} className="max-w-6xl mx-auto mb-8" style={{ opacity: 0 }}>
                        <div className="flex flex-wrap gap-6 justify-center">
                            <div className="flex gap-3 items-center">
                                <button
                                    onClick={() => setMenuSelectedLayout("grid")}
                                ...
                                <button
                                    onClick={() => setMenuSelectedLayout("list")}
                                    className={`p-2 rounded-lg border transition-all duration-300 ${
                          ...
                          {getStatusLabel(task.userTask.status)}
                            ...
                            <div ref={tasksListRef} className="space-y-4">
                                {filteredTasks.map((task) => (
                                    <div
                                        key={task.id}
                                        className="group bg-gradient-to-br from-gray-800/50 to-gray-900/50 backdrop-blur-sm border border-gray-700/50 rounded-xl p-6 hover:border-cyan-500/50 transition-all duration-300 hover:scale-[1.005] cursor-pointer flex flex-col md:flex-row md:items-center justify-between gap-4"
                                        style={{ opacity: 0 }}
                                    >
                          ...
                          >
                            {getDifficultyLabel(task.difficulty)}
                                                    ...
                                                    <div className="flex items-center space-x-2">
                                                        ...
                                                        <span className="text-gray-300 font-medium text-sm">{task.language.name}</span>
                                                    </div>
                                                </div>
                                            </div>
